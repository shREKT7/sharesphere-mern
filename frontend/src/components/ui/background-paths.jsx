        ...
        <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    >
                        <p className="max-w-[42rem] mx-auto text-muted-foreground sm:text-xl sm:leading-8 mb-4">
                            ShareSphere is your modern community resource sharing platform.
                            Borrow tools, books, and equipment from your neighbors instead of buying new.
                            Sustainable, community-driven, and completely free.
                        </p>
                    </motion.div>
                </motion.div>
            </div>
